...
type SortKey = "company_name" | "followers" | "avg_likes"
...
export function BanksList({ data, onBankClick }: BanksListProps) {
  ...
  return (
    <div className="space-y-4">
      <Input
        placeholder="Sug'urta kompaniyalari nomi yoki foydalanuvchi nomi orqali qidirish..."
        value={searchTerm}
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-slate-800">
              ...
              >
                Sug'urta nomi {sortKey === "company_name" && (sortOrder === "asc" ? "▲" : "▼")}
              </th>
              ...
              <th
                ...
                className="text-right py-3 px-4 text-slate-400 font-semibold cursor-pointer hover:text-white"
              >
                O'rtacha yoqtirishlar soni {sortKey === "avg_likes" && (sortOrder === "asc" ? "▲" : "▼")}
              </th>
